...
class DexRukav2HandlerLeft:
    def __init__(self, urdf_path="/home_shared/grail_sissi/bimanual/Franka-Teach/RUKA/assets/robot.urdf", config_path="/Users/sissi/Downloads/RUKA/assets/dex_retarget.yml", hand_type="left"):
