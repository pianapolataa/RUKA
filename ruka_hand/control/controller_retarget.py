...
class DexRukav2Handler:
    ...
    def points_to_joint_angles(self, points):
        ...
        angles[8] = finger_deg['index_mcp'] * 1.27
        # angles[8] = finger_deg['index_mcp'] * 1.5
        angles[6] = (finger_deg['index_pip'] + finger_deg['index_dip']) * 2.3 / 3
        # angles[6] = 0
        angles[10] = finger_deg['mid_mcp']
        angles[9] = (finger_deg['mid_pip'] + finger_deg['mid_dip']) * 2.3 / 3
        # angles[9] = 0
        angles[3] = finger_deg['ring_splay']
        angles[4] = finger_deg['ring_mcp'] * 1.1
        angles[5] = (finger_deg['ring_pip'] + finger_deg['ring_dip']) * 2.3 / 3
        angles[1] = finger_deg['pinky_splay']
        angles[0] = finger_deg['pinky_mcp']
        angles[2] = (finger_deg['pinky_pip'] + finger_deg['pinky_dip']) * 2.3 / 3
        angles[12] = finger_deg['thumb_cmc'] * 1.1
        angles[13] = finger_deg['thumb_mcp'] * 1.1
        angles[11] = finger_deg['thumb_ip']
