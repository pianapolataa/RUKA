...
class Hand:
    ...
    def __init__(self, hand_type="right"):
        ...
        if hand_type == "right":
            ...
            self.curled_bound = np.array([1835, 3066, 3132, 2300, 1039, 818, 2140, 1460, 1681, 847, 623, 2000, 1560, 2160, 2419, 2800])
            self.tensioned_pos = np.array([1286, 2658, 1918, 2507, 663, 1847, 1330, 1350, 923, 1968, 1259, 1700, 781, 1620, 3333, 3664])
