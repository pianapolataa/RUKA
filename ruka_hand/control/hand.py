...
class Hand:
    ...
    def __init__(self, hand_type="right"):
        ...
        if hand_type == "right":
            self.curled_bound = np.array([1850, 2540, 1617, 1860, 1730, 2900, 1520, 1850, 1573, 3229, 3237, 1300, 520, 1430, 1617, 2455])
            self.tensioned_pos = np.array([2400, 2140, 2550, 2160, 2320, 1920, 2500, 2100, 2200, 2300, 2550, 1540, 1400, 2080, 2417, 1810])
        elif hand_type == "left":
            self.curled_bound = np.array([3000, 1777, 2740, 2473, 2437, 1751, 3040, 3091, 3316, 1253, 551, 1483, 3221, 2128, 2439, 3294])
            self.tensioned_pos = np.array([2297, 1261, 1629, 3477, 2010, 1870, 2090, 2837, 2790, 1694, 1440, 1550, 2294, 1884, 3110, 2600])
