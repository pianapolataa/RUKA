...
class Hand:
    ...
    def __init__(self, hand_type="right"):
        ...
        if hand_type == "right":
            self.curled_bound = np.array([2815, 2769, 1384, 1939, 2857, 1824, 2195, 1676, 1000, 1444, 1207, 1129, 2774, 2357, 1617, 1850])
            self.tensioned_pos = np.array([3559, 3177, 2247, 1756, 3407, 849, 3098, 1833, 1490, 853, 230, 1500, 3455, 2860, 2417, 1400])
        elif hand_type == "left":
            self.curled_bound = np.array([1572, 2919, 1616, 3013, 3157, 2340, 1034, 1757, 3502, 1591, 511, 1952, 2170, 3380, 2948, 1338])
            self.tensioned_pos = np.array([1040, 2581, 660, 3947, 2973, 2814, 746, 1070, 3364, 2197, 1502, 1800, 1864, 2496, 2948, 1927])
