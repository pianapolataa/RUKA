...
class Hand:
    ...
    def __init__(self, hand_type="right"):
        ...
        if hand_type == "right":
            ...
            self.curled_bound = np.array([3000, 1777, 2740, 2473, 2437, 1751, 3040, 3091, 3316, 1253, 551, 1450, 3221, 1700, 2439, 2600])
            self.tensioned_pos = np.array([2297, 1261, 1629, 3477, 2010, 1870, 2090, 2837, 2790, 1694, 1440, 1300, 2294, 2100, 3110, 3294])
