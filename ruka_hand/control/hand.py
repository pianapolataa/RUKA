...
class Hand:
    ...
    def __init__(self, hand_type="right"):
        ...
        if hand_type == "right":
            self.curled_bound = np.array([2070, 2585, 1750, 1930, 2100, 2900, 1680, 2020, 1900, 3110, 2830, 1273, 750, 1800, 1700, 2380])
            self.tensioned_pos = np.array([2700, 2170, 2650, 2120, 2680, 1850, 2600, 2200, 2500, 2050, 2100, 1545, 1500, 2270, 2300, 1950])
