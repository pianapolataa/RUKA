...
class Hand:
    ...
    def __init__(self, hand_type="right"):
        ...
        if hand_type == "right":
            self.curled_bound = np.array([2815, 2769, 1384, 1939, 2857, 1824, 2195, 1676, 1000, 1444, 1207, 1300, 520, 1430, 1617, 1850])
            self.tensioned_pos = np.array([3559, 3177, 2247, 1756, 3407, 849, 3098, 1833, 1490, 853, 230, 1540, 1400, 2080, 2417, 1400])
        elif hand_type == "left":
