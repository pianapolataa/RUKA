...
class Hand:
    ...
    def __init__(self, hand_type="right"):
        ...
        if hand_type == "right":
            self.curled_bound = np.array([2682, 2540, 1854, 1860, 1730, 2900, 1520, 1850, 1573, 3229, 3237, 1300, 520, 1430, 1617, 1850])
            self.tensioned_pos = np.array([3435, 2140, 2746, 2160, 2320, 1920, 2500, 2100, 2200, 2300, 2550, 1540, 1400, 2080, 2417, 1400])
        elif hand_type == "left":
