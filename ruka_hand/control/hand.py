...
class Hand:
    ...
    def __init__(self, hand_type="right"):
        ...
        if hand_type == "right":
            ...
            self.curled_bound = np.array([1572, 2919, 1616, 3013, 3157, 2340, 1034, 1757, 3502, 1591, 511, 1952, 2170, 3380, 3204, 1338])
            self.tensioned_pos = np.array([1040, 2581, 660, 3947, 2973, 2814, 746, 1070, 3364, 2197, 1502, 1800, 1864, 2496, 2601, 1927])
