...
class Hand:
    ...
    def __init__(self, hand_type="right"):
        ...
        if hand_type == "right":
            self.curled_bound = np.array([2682, 2540, 1854, 1860, 1730, 2900, 1520, 1850, 1573, 3229, 3237, 1300, 520, 1430, 1617, 2455])
            self.tensioned_pos = np.array([3435, 2140, 2746, 2160, 2320, 1920, 2500, 2100, 2200, 2300, 2550, 1540, 1400, 2080, 2417, 1810])
        elif hand_type == "left":
            self.curled_bound = np.array([3000, 1777, 2740, 2473, 2437, 1751, 3040, 3091, 3316, 1253, 551, 1300, 3221, 2100, 2439, 2600])
            self.tensioned_pos = np.array([2297, 1261, 1629, 3477, 2010, 1870, 2090, 2837, 2790, 1694, 1440, 1450, 2294, 1700, 3110, 3294])
