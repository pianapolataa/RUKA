...
USB_PORTS = {"left": "/dev/tty.usbserial-FTAU5737", "right": "/dev/ttyUSB0", "v1_right": "/dev/ttyUSB0"} #/dev/tty.usbserial-FTAA0B7K /dev/tty.usbserial-FTAU573 # /dev/ttyUSB0 or 1
