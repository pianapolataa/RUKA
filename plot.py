...
static_data = np.array([
    [[-0.00, -0.04,  0.04], [-0.03, -0.09,  0.02], [ 0.03,  0.03,  0.08], [ 0.01,  0.05,  0.10], [-0.01,  0.06,  0.12]], # Thumb
    [[-0.00, -0.04,  0.04], [-0.04, -0.10, -0.04], [ 0.02,  0.05,  0.13], [ 0.01,  0.04,  0.11], [ 0.02,  0.02,  0.10]], # Index
    [[-0.00, -0.04,  0.04], [-0.02, -0.08, -0.05], [-0.00,  0.04,  0.14], [-0.00,  0.03,  0.11], [ 0.01,  0.01,  0.10]], # Middle
    [[-0.00, -0.04,  0.04], [-0.00, -0.07, -0.05], [-0.02,  0.03,  0.13], [-0.02,  0.02,  0.10], [-0.00,  0.00,  0.09]], # Ring
    [[-0.00, -0.04,  0.04], [ 0.02, -0.07, -0.04], [-0.03,  0.02,  0.12], [-0.03,  0.01,  0.10], [-0.02, -0.01,  0.09]]  # Pinky
])
