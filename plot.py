...
static_data = np.array([
    [[-0.00, -0.04,  0.04], [-0.01, -0.01,  0.08], [-0.02,  0.02,  0.11], [-0.03,  0.04,  0.14], [-0.04,  0.05,  0.16]], # Thumb
    [[-0.00, -0.04,  0.04], [ 0.04,  0.01,  0.13], [ 0.05,  0.02,  0.16], [ 0.06,  0.03,  0.19], [ 0.08,  0.04,  0.21]], # Index
    [[-0.00, -0.04,  0.04], [ 0.06,  0.00,  0.12], [ 0.08,  0.02,  0.15], [ 0.10,  0.03,  0.17], [ 0.12,  0.04,  0.19]], # Middle
    [[-0.00, -0.04,  0.04], [ 0.07,  0.00,  0.10], [ 0.10,  0.01,  0.12], [ 0.12,  0.02,  0.14], [ 0.13,  0.03,  0.16]], # Ring
    [[-0.00, -0.04,  0.04], [ 0.07,  0.00,  0.07], [ 0.10,  0.00,  0.09], [ 0.12,  0.01,  0.09], [ 0.14,  0.02,  0.10]]  # Pinky
])
