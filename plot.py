...
static_data = np.array([
    [[-0.00, -0.04,  0.04], [ 0.02,  0.00,  0.06], [ 0.02,  0.03,  0.08], [ 0.00,  0.05,  0.10], [-0.02,  0.05,  0.12]], # Thumb
    [[-0.00, -0.04,  0.04], [ 0.04,  0.01,  0.13], [ 0.02,  0.04,  0.14], [ 0.01,  0.04,  0.12], [ 0.02,  0.02,  0.11]], # Index
    [[-0.00, -0.04,  0.04], [ 0.02, -0.00,  0.14], [-0.00,  0.04,  0.14], [-0.00,  0.03,  0.11], [ 0.01,  0.01,  0.11]], # Middle
    [[-0.00, -0.04,  0.04], [-0.00, -0.01,  0.14], [-0.02,  0.03,  0.14], [-0.02,  0.02,  0.11], [-0.01,  0.00,  0.10]], # Ring
    [[-0.00, -0.04,  0.04], [-0.03, -0.02,  0.13], [-0.03,  0.02,  0.13], [-0.03,  0.02,  0.11], [-0.02, -0.00,  0.10]]  # Pinky
])
