...
static_data = np.array([
    [[ 0.,   -0.04,  0.04], [ 0.02,  0.,    0.06], [ 0.03,  0.03,  0.08], [ 0.02,  0.06,  0.1 ], [-0.,    0.06,  0.12]], # Thumb
    [[ 0.,   -0.04,  0.04], [ 0.04,  0.01,  0.13], [ 0.02,  0.05,  0.14], [ 0.01,  0.04,  0.11], [ 0.02,  0.02,  0.11]], # Index
    [[ 0.,   -0.04,  0.04], [ 0.02, -0.,    0.14], [-0.,    0.04,  0.14], [-0.01,  0.04,  0.11], [ 0.01,  0.01,  0.1 ]], # Middle
