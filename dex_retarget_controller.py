...
class DexRukav2Handler:
    ...
    def points_to_joint_angles(self, points):
        ...
        angles[6] = max(finger_deg['index_pip'],finger_deg['index_dip']) 
        angles[10] = finger_deg['mid_mcp']
        angles[9] = max(finger_deg['mid_pip'], finger_deg['mid_dip']) 
        angles[3] = finger_deg['ring_splay']
        angles[4] = finger_deg['ring_mcp']
        angles[5] = max(finger_deg['ring_pip'], finger_deg['ring_dip'])
        angles[1] = finger_deg['pinky_splay']
        angles[0] = finger_deg['pinky_mcp']
        angles[2] = max(finger_deg['pinky_pip'], finger_deg['pinky_dip'])
        angles[12] = finger_deg['thumb_cmc']
        angles[13] = finger_deg['thumb_mcp']
